...
const columns: DataTableColumns<RaquelDraft> = [
...
<template>
  <div>
    <PageHeader title="Drafts" subtitle="Manage Raquel drafts" :count="draftsStore.totalCount" />

    <ActionBar>
      <NSpace>
        <NButton type="primary" @click="router.push('/dashboard/raquel/drafts/new')">Add</NButton>
    ...
    <NDataTable
      ...
      :row-key="(row: RaquelDraft) => row.id"
